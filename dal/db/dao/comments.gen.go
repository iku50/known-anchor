...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.UserID = field.NewUint(tableName, "user_id")
	_comment.PostID = field.NewUint(tableName, "post_id")
	_comment.Content = field.NewString(tableName, "contect")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.Content = field.NewString(table, "contect")
...
type ICommentDo interface {
	...
	FindByID(id uint) (result model.Comment, err error)
}

// Where("id=@id")
func (c commentDo) FindByID(id uint) (result model.Comment, err error) {
